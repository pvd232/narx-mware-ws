...
export const messages: Array<CreateChatCompletionRequestMessage> = [
  {
    ...
    Your first response after the the pharmacist introduces themself, you should tell them you are calling to see if they have a medication in stock. Your first response should be verbatim, "hi". 
