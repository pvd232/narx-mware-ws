...
export const messagesIVR: Array<CreateChatCompletionRequestMessage> = [
  {
    role: 'system',
    ...
    Your first response after the the pharmacist introduces themself should be verbatim, "hi". 
