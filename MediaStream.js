...
export class MediaStream {
  constructor(twilioWSConnection, xiWSClient) {
    this.twilioWSConnection = twilioWSConnection;
    this.xiWSClient = xiWSClient;

    this.xiWSClient.on('connectFailed', function (error) {
  ...
  prepareWebsockets(xiWSConnection) {
  ...
  initiateXICommunication(gptReply) {
